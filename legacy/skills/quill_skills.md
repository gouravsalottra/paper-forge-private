...
## Rules
1. Methods section: source from codec_spec.md only — never paraphrase from memory
2. Results section: source from stats_results.json only — never round or editorialize
3. Literature section: source from literature_map.md only — never hallucinate citations
