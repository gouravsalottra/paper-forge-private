"""CODEAUDIT Pass 1: code-to-spec audit with code-only context."""
...
class CodecPass1:
    ...
    def _call_gpt4o(self, code_context: str) -> str:
        ...
        system_prompt = (
            "You are CODEAUDIT Pass 1. Analyze ONLY the provided codebase content. "
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run CODEAUDIT pass 1 (code-only audit).")
