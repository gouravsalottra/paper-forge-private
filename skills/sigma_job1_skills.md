...
4. Commit PAP to pap table, set hypothesis_lock.locked_at to current UTC timestamp
5. Output: hypothesis_lock row with locked_at set — this is the only output that matters
